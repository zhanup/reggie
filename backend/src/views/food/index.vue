        ...
        <el-table-column prop="image" label="图片" align="center">
          <template slot-scope="{ row }">
            <el-image
              ...
              :preview-src-list="[`/api/common/download?name=${row.image}`]"
            >
...
import { getDishPage, deleteDish, dishStatusByStatus } from '@/api/food'
